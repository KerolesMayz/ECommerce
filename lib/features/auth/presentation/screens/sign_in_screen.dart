...
import 'package:ecommerce_app/features/auth/cubit/sign_in_view_model.dart';
      ...
      listener: (context, state) {
        switch (state) {
          ...
          case SignInLoadingState():
            signInViewModel.onLoadingState(context);
          case SignInErrorState():
            DialogUtils.hideDialog(context);
            signInViewModel.onErrorState(context, state.errorMessage);
